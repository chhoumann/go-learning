...
import (
	...
	"github.com/chhoumann/snippetbox/internal/validator"
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Name, 255), "name", "Name cannot be longer than 255 characters")

	form.CheckField(validator.NotBlank(form.Email), "email", "Email cannot be blank")
	form.CheckField(validator.MaxChars(form.Email, 255), "email", "Email cannot be longer than 255 characters")
	...
	form.CheckField(validator.MinChars(form.Password, 10), "password", "Password must be at least 10 characters long")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// Good to do when auth state or priviledge levels change (e.g. login, logout, change password, etc.)
